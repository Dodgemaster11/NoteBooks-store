            ...
            <div id="block-top-auth">
                <form method="post">
                    <ul id="input-email-pass">
                        ...
                        <li><input  type="text" id="auth-login" placeholder="Логин или E-mail" /></li>
                        <li><input  type="text" id="auth-pass" placeholder="Пароль" /></li>
                        <ul id="list-auth">
            ...
            <ul id="option-list">
                ...
                <li><a id="select-sort">Нет сортировки</a>
                    <ul id="sorting-list">
                        ...
                        <li><a href="index11.php?sort = priceasc">От дешевых к дорогим</a></li>
                        <li><a href="index11.php?sort = pricedesc">От дорогих к дешевым</a></li>
                        <li><a href="index11.php?sort = popular">Популярное</a></li>
                        <li><a href="index11.php?sort = news">Новинки</a></li>
                        <li><a href="index11.php?sort = brand">От А до Я</a></li>
